...
func hacker_close(txHash string) {
	...
	if hacker_env != nil || hacker_call_stack != nil {
		...
		// NAO USADA oracles = append(oracles, NewHackerCallEtherTransferFailed())
		...
		// NAO USADO oracles = append(oracles, NewHackerCallOpInfo())
		oracles = append(oracles, NewHackerSendOpInfo())
		// NAO USADO oracles = append(oracles, NewHackerCallExecption())
		// NAO USADO oracles = append(oracles, NewHackerRepeatedCall())
		oracles = append(oracles, NewHackerEtherTransfer())
		oracles = append(oracles, NewHackerStorageChanged())
		// NAO USADO oracles = append(oracles, NewHackerUnknowCall())
		oracles = append(oracles, NewHackerTimestampOp())
		// NAO USADO oracles = append(oracles, NewHackerRootCallFailed())
		oracles = append(oracles, NewHackerNumberOp())
		// NAO USADA oracles = append(oracles, NewHackerBlockHashOp())
		// NAO USADA oracles = append(oracles, NewHackerBalanceGtZero())
